...
// Check connection
                ...
                FROM grades,assignment WHERE grades.assignment_id=assignment.id AND assignment.assignment_no='$assignment_no' AND assignment.class_id='$class_id' ";
