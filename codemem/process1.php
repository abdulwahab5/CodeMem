...
// Check connection
                            ...
                            $sql = "UPDATE assignment SET assignment_no='$assignment_no',due_date='$due_date',upload_date=CURDATE(),assignment_path='$assignment_path',solution_path='$solution_path',class_id='$class_id' WHERE assignment_no='$value[0]' AND class_id='$value[1]'";
