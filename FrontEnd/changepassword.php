                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <form class="form" method="post" action="changepassword.php">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Current Password" name="curr">
                            </div>
                            <div class="form-group">
                                <label>New Password</label>
                                <input id="text" class="form-control" placeholder="New Password" name="new">
                            </div>

                            <div class="form-group">
                                <label>Confirm Password</label>
                                <input type="text" class="form-control" placeholder="Confirm Password" name="c_new">
                            </div>
